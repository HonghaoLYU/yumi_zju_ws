...
class MoveGroupPythonInteface(object):
    ...
    def echo_neuron_pose(self):
        ...
        print (a[1] * 180 / 3.14, a[0] * 180 / 3.14, a[2] * 180 / 3.14)
        print "可穿戴设备左手欧拉角转换后 %s"
        print (a[7] * 180 / 3.14, a[6] * 180 / 3.14, a[8] * 180 / 3.14)
    ...
    def log_robot_pose(self):
        ...
        sheet1.write(count, 11, right_pose_goal.position.x)
        sheet1.write(count, 12, right_pose_goal.position.y)
        sheet1.write(count, 13, right_pose_goal.position.z)
        sheet1.write(count, 14, right_rpy[0])
        sheet1.write(count, 15, right_rpy[1])
        sheet1.write(count, 16, right_rpy[2])
        # sheet1.write(count, 17, right_pose_goal.orientation.x)
        # sheet1.write(count, 18, right_pose_goal.orientation.y)
        # sheet1.write(count, 19, right_pose_goal.orientation.z)
        # sheet1.write(count, 20, right_pose_goal.orientation.w)
        sheet1.write(count, 21, time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()))
        # 记录左臂数据
        sheet2.write(count, 0, count)
        sheet2.write(count, 1, left_pose_goal.position.x)
        sheet2.write(count, 2, left_pose_goal.position.y)
        sheet2.write(count, 3, left_pose_goal.position.z)
        sheet2.write(count, 4, left_rpy[0])
        sheet2.write(count, 5, left_rpy[1])
        sheet2.write(count, 6, left_rpy[2])
        # sheet2.write(count, 7, left_pose_goal.orientation.x)
        # sheet2.write(count, 8, left_pose_goal.orientation.y)
        # sheet2.write(count, 9, left_pose_goal.orientation.z)
        # sheet2.write(count, 10, left_pose_goal.orientation.w)
        sheet2.write(count, 11, left_pose_goal.position.x)
        sheet2.write(count, 12, left_pose_goal.position.y)
        sheet2.write(count, 13, left_pose_goal.position.z)
        sheet2.write(count, 14, left_rpy[0])
        sheet2.write(count, 15, left_rpy[1])
        sheet2.write(count, 16, left_rpy[2])
        # sheet2.write(count, 17, left_pose_goal.orientation.x)
        # sheet2.write(count, 18, left_pose_goal.orientation.y)
        # sheet2.write(count, 19, left_pose_goal.orientation.z)
        # sheet2.write(count, 20, left_pose_goal.orientation.w)
